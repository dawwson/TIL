...
- 예를 들어, 해시 함수의 input이 'abc'라면 output이 1234가 되는 것이다. 이때 1234를 해시라고 한다.
  ...
  <img width="912" alt="image" src="https://github.com/dawwson/TIL/assets/45624238/a469c57a-7b58-4896-b523-6ada19af0618">
  <span style="color: gray;">출처 : 노마드코더 유튜브</span>
...
- 해시 충돌이 발생했을 때 그저 같은 버킷 링크드 리스트의 마지막 노드로 해당 값을 추가해주기만 하면 된다.
  ...
  <img width="894" alt="image" src="https://github.com/dawwson/TIL/assets/45624238/027347e8-b3a5-4b67-8ba9-1c1f3fc73f44">
  <span style="color: gray;">출처 : 노마드코더 유튜브</span>
